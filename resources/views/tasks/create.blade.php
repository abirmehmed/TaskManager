...
<div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <form method="POST" action="{{ route('tasks.store') }}" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="mb-4">
            <label for="due_date" class="block text-gray-700 font-medium mb-2">Due Date (optional)</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Save Task</button>
        </div>
    </form>
</div>
@endsection